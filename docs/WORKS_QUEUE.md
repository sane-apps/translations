...
| **in progress** | `cyril-alexandria-adoration-1` | *De adoratione* Books 2–6 (Book 1 already on the site) | Books 2–5 English OET COMPLETE (Book 5 tips `98121d3` / `bb17175` / `0532c6c`). Next: Book 6. **Skip Melito.** OET = no previous complete English. **Never Cyril Matthew.** |
