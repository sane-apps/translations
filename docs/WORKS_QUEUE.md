...
| **active** | `origen-matthew-later` | Origen Comm. Matthew 15–17 + Series (Latin) | Opening tip `515bbfbd` (after Romans `3394ac4c`). Tomus XV CLOSEOUT tip `6b37f613`. Tomus XVI opening tip `32889344`. Tomus XVI CLOSEOUT `7318a096`; XVII open `bbf4c479`. Tomus XVII CLOSEOUT `c3f0e01a`; Series open `aa8960a4`. Series rem tip `3601a95d`. Next: Series continue → CLOSEOUT, then next Rank-1. PG 13. Melito skipped. Never Cyril Matthew densify. No Heine. |
