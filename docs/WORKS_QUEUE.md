...
| **in progress** | `cyril-alexandria-adoration-1` | *De adoratione* Books 2–5 (Book 1 already on the site) | Books 2–4 English OET COMPLETE (Book 4 tip `5ddd71c`). Next: Book 5. **Skip Melito.** OET = no previous complete English. **Never Cyril Matthew.** |
