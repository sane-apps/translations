...
| **in progress** | `cyril-alexandria-adoration-1` | *De adoratione* Books 2–7 (Book 1 already on the site) | Books 2–6 COMPLETE; Book 6 tip `b11bf5b` (37/37). Next Book 7 same slug. **Skip Melito.** OET = no previous complete English. **Never Cyril Matthew.** |
