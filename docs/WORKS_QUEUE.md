...
| **active** | `cyril-alexandria-trinity-dialogue-1` | Trinity Dialogue 1 (CPG 5216) | **ACTIVE** after Origen Rank-1 OET exhaustion (`af9c9531`). Opening tip `94dbb869`. Dial.1 rem next. PG 75. Melito skipped. Never Cyril Matthew densify. True OET — no ANF for dialogues; no Durand SC English base. |
