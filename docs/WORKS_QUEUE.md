...
| **in progress** | `cyril-alexandria-adoration-1` | *De adoratione* Books 2–8 (Book 1 already on the site) | Books 2–7 COMPLETE; Book 7 tip `95a3269` (28/28). Next Book 8 same slug. **Skip Melito.** OET = no previous complete English. **Never Cyril Matthew.** |
