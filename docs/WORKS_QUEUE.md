...
| **active** | `origen-matthew-later` | Origen Comm. Matthew 15–17 + Series (Latin) | Opening tip `515bbfbd` (after Romans `3394ac4c`). Tomus XV CLOSEOUT tip `6b37f613`. Tomus XVI opening tip `32889344`. Tomus XVI CLOSEOUT `7318a096`; XVII open `bbf4c479`. Next: XVII rem → Series. PG 13. Melito skipped. Never Cyril Matthew densify. No Heine. |
