...
| **in progress** | `origen-jeremiah-samuel` | Homilies on Jeremiah (Greek) + Homily on 1 Kingdoms 28; GCS III | Homilies **1–20** Pass B (Homily **8** literary-polished Air OET tip). **1 Sam 28** English on tip `855673e`. **Lamentations** fr. §§1–110 OET on tip (118 total; continue §§111+). |
