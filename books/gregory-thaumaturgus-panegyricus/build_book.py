...
OUT_DOCX = BOOK_DIR / "gregory-thaumaturgus-panegyricus.docx"
RECEIPT = BOOK_DIR / "build_receipt.json"

ENGLISH_FILE = "panegyricus_english.json"
...
def main() -> None:
    ...
    add_heading_with_headword(doc, bookmarks, "Panegyric and Thanksgiving to Origen", 1, "panegyricus-work")
