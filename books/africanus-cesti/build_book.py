...
FRONT_MATTER = [
    ...
    "Scope: tip of Julius Africanus, Cesti book 7 through the missile seal and colophon (7.20). Appendix after the colophon and the pinax of book 2 are not in this volume.",
