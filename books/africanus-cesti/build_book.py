...
FRONT_MATTER = [
    ...
    "Scope: tip of Julius Africanus, Cesti book 7 through the opening of the farming paradoxes (7.19 wine, vinegar, oil, garum). The rest of that chapter and the missile seal are not in this volume.",
