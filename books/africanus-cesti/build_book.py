...
FRONT_MATTER = [
    ...
    "Scope: tip of Julius Africanus, Cesti book 7 through theft of sound (7.16). Staying awake, elephants, farming paradoxes, and the missile seal are not in this volume.",
