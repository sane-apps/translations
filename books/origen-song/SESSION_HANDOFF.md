...
# Origen Song — session handoff

## Charter

- Slug: `origen-song`
- Scope: Baehrens GCS Orig. VIII / GCS 33 (1925): Jerome’s **2 Homilies** on the Song + Rufinus’s **Commentary** (4 books) as surviving.
- **OET:** no usable PD English (ANF lacks these; Lawson ACW 26 copyrighted — sense-check only, never wording).
- Standing: Melito skipped. Never Cyril Matthew densify. Tip merge-ready for Merge-and-ship. Keep Macs caffeinated.

## State

- 2026-09-13 (Air): Next true earliest Rank-1 OET after `origen-john-later` series CLOSEOUT `959ffcc` / stamp `b6a950f`.
- Densify: Demonstration already done. Cyril Matthew fragments corpus **290/290** complete (WQ row was stale “fr.5+”; do **not** densify). Melito skipped.
- Sources locked: IA `origeneswerkehrs08origuoft` + `GCS33` Baehrens 1925 OCR/text PDF.
- **Homilia I §§1–10** Pass A≠B OET first tip (this claim).
