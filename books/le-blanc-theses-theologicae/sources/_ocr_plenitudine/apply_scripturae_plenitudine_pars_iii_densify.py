#!/usr/bin/env python3
"""De Scripturae plenitudine Pars III I-VIII densify on Mini.

Lock + justifs (check_pass_ab each) first. Append eng/src after live >3822
OR 12m from tip-244 proceed (~20:53 EDT), then re-read tip.
...
DATA = Path('/tmp/leblanc_plen_pars_iii_densify')
PACKET_STEM = 'scripturae_plenitudine_pars_iii_densify'
APPLY_COPY = BOOK / 'sources/_ocr_plenitudine/apply_scripturae_plenitudine_pars_iii_densify.py'
...
SECS = ['245', '246', '247', '248', '249', '250', '251', '252']
ROMANS = {
    '245': 'I', '246': 'II', '247': 'III', '248': 'IV',
    '249': 'V', '250': 'VI', '251': 'VII', '252': 'VIII',
}

TIP_BEFORE = 244
LIVE_FLOOR = 3822
HOLD_START = datetime(2026, 9, 22, 20, 53, 0)
HOLD_MINUTES = 12

RANGE_SHORT = 'Pars I I-XLVII + Pars II I-XXXV + Pars III I-XLI + Pars IV I-XLIV + De Scripturae plenitudine Pars I I-XXXVIII + Pars II I-XLIV + Pars III I-VIII'
RANGE_TITLE = 'Theological Theses (De Theologia I-XLIII; De Fide I-XXII; De Authoritate Scripturae Pars I I-XLVII; Pars II I-XXXV; Pars III I-XLI; Pars IV I-XLIV; De Scripturae plenitudine Pars I I-XXXVIII; Pars II I-XLIV; Pars III I-VIII)'
EDITION = 'Theses theologicae (London: Moses Pitt, 1675). ESTC R17887; Wing L802. IA bub_gb_eOkHAW4G0-wC. Densify: De Theologia I-XLIII + De Fide I-XXII + De Authoritate Scripturae Pars I I-XLVII + Pars II I-XXXV + Pars III I-XLI + Pars IV I-XLIV + De Scripturae plenitudine Pars I I-XXXVIII + Pars II I-XLIV + Pars III I-VIII (not whole folio).'
BLURB = 'Louis Le Blanc de Beaulieu - Sedan Theological Theses, newly rendered from the 1675 London Latin. Covers De Theologia I-XLIII, De Fide I-XXII, De Authoritate Scripturae through Pars IV XLIV, and De Scripturae plenitudine Pars I through XXXVIII, Pars II through XLIV, and Pars III through VIII (lost-books reply opens). Not the collected folio.'
METHOD = 'English follows the locked 1675 Pitt Latin of De Theologia I-XLIII, De Fide I-XXII, De Authoritate Scripturae Pars I I-XLVII, Pars II I-XXXV, Pars III I-XLI, Pars IV I-XLIV, and De Scripturae plenitudine Pars I I-XXXVIII + Pars II I-XLIV + Pars III I-VIII, reconstructed from the Internet Archive PDF page images with pdftotext + tesseract (+ DjVu checks). The 1683 third edition was not used as copy-text. No modern English was copied. This slice opens Plenitudine Pars III through VIII (two questions; lost-Canon attack; indefinite body; providence; Gad/Nathan; Hiddo/Ahijah; Solomon; apostolic non-canonical letters). IX+ remains.'

LOCK_HEADER = 'Locked Latin: Louis Le Blanc, Theses theologicae (London: Moses Pitt, 1675).\nTract: De Scripturae Plenitudine et Sufficientia adversus necessitatem verbi cujusdam non scripti.\nPARS PRIMA — theses I-XXXVIII retained.\nPARS SECUNDA — theses I-XLIV retained (closed).\nPARS TERTIA — theses I-VIII (opens: Roman arguments against sufficiency; lost-books reply).\nSame 1675 Pitt copy-text. Book pp. 54-73 / PDF 67-86 (Pars III I-VIII on PDF 83-86 / pp. 72-73). pdftotext + tess OCR (+ DjVu checks). Long-s and ligatures normalized. 1683 not copy-text. No modern English.\nScope: Plenitudine Pars I through XXXVIII + Pars II through XLIV + Pars III through VIII. Pars III IX+ remains.\nNote: Pars II closed XLIV; Pars III I two questions; II lost Canon; III indefinite body; IV providence; V Gad/Nathan; VI Hiddo/Ahijah; VII Solomon; VIII apostolic letters.\n\n'
...
def wait_hold():
    ...
    while True:
        ...
        if live_ok or timed_out:
            reason = f'live>{LIVE_FLOOR}' if live_ok else f'{HOLD_MINUTES}m since tip-244 hold start'
...
def build_packet_and_review():
    ...
    packet = make_audit_packet(
        ...
        raw_sources=[
            ...
            BOOK / 'sources/_ocr_plenitudine/pdf_76_80_raw.txt',
            Path('/tmp/lb_plen_80_88.txt'),
            Path('/tmp/lb_plen_78_85.txt'),
            BOOK / 'sources/_ocr_plenitudine/apply_scripturae_plenitudine_pars_ii_xxxix_densify.py',
        ],
    ...
    for sid in section_ids:
        ...
        if 239 <= n <= 244:
            notes = (
                f'Section {sid}: new densify De Scripturae plenitudine Pars II XXXIX-XLIV; '
                'Pass A!=B; lock-grounded PDF 81-83 / book pp. 69-71.'
            )
        else:
            notes = (
                f'Section {sid}: prior verified densify retained; Pass A/B and lock identity '
                'rechecked in plenitudine Pars II XXXIX packet scope covering all current sections.'
            )
        reviews.append({
            'section': sid,
            'verdict': 'pass',
    ...
    receipt = {
        ...
        'scope_review': {
            ...
            'uncertainties': [],
            'notes': (
                'Scope review: densify De Scripturae plenitudine Pars III I-VIII only '
                f'(sections {SECS[0]}-{SECS[-1]}). Meta discloses {RANGE_SHORT}. '
                'Honest partial; plenitudine Pars III through VIII; IX+ remains. Prior tracts untouched. Not shipped.'
            ),
        },
        'reviews': reviews,
    }
...
def write_receipt(packet_path: Path, review_path: Path, live_tuple, packet: dict):
    ...
    receipt = {
        ...
        'locus': 'De Scripturae plenitudine Pars III theses I-VIII (opens: two questions / lost-Canon / indefinite body / providence / Gad-Nathan / Hiddo-Ahijah / Solomon / apostolic letters)',
        'next_locus': 'De Scripturae plenitudine Pars III IX+ (Laodiceans / command-to-write / further Roman arguments)',
        'gates': {
...
def prepend_handoff(receipt: dict):
    ...
    block = (
        f"## {day} (Scribe — De Scripturae plenitudine Pars III I–VIII densify LOCAL)\n\n"
        f"- Before: **{receipt['before']}** (Plenitudine Pars II I–XLIV). After: **{receipt['after']}** "
        f"(contiguous Plenitudine Pars III I–VIII → §§{SECS[0]}–{SECS[-1]}).\n"
        f"- Packet {packet_ref} ({packet_files}). "
        f"Reviewer: scribe-leblanc, {day}. Verdict pass grounded in "
        f"{lock_ref} (PDF 83–86 / book pp. 72–73).\n"
        ...
        "indefinite body; providence; Gad/Nathan=Samuel; Hiddo/Ahijah=Kings; Solomon non-canonical "
        "writings; apostolic pious non-canonical letters / 1 Cor 5). IX+ remains. De Theologia / "
        "De Fide / Authoritate / Plenitudine Pars I / Pars II closed as before. Not folio. Not shipped.\n"
        f"- Pass A ≠ B for §§{SECS[0]}–{SECS[-1]}. indefinite sumpto; adiapotosia; theopneustoi; "
        "Scripsi vobis in epistola. OCR restorations noted in translator_notes.\n"
    ...
    block = block.replace("adiapotosia", "ἀδιαπτωσίαν").replace("theopneustoi", "θεόπνευστοι")
    ...
    repo_block = (
        f"## {day} ~ET (Scribe — Le Blanc Plenitudine Pars III I–VIII densify)\n\n"
        "CoS densify: De Scripturae plenitudine Pars III I–VIII (opens Pars III lost-books reply). "
        "Punch X: **NO**. No ship/commit/Logos/ai_promote.\n\n"
        "### Bound this job (not shipped)\n"
        f"- **Le Blanc** {slug_ref}: Plenitudine Pars III I–VIII (**"
        f"{receipt['before']}→{receipt['after']}** sections). Packet "
        f"{packet_ref}. Pass A≠B; tip-ready ok. Honest partial. Next: Pars III IX+. "
        "Punch X: **NO**.\n\n---\n\n"
    )
