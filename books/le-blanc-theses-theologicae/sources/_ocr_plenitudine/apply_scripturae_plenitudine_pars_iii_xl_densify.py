#!/usr/bin/env python3
"""De Scripturae plenitudine Pars III XL-XLVII densify on Mini.

Lock + justifs (check_pass_ab each) first. Append eng/src after live >3983
OR 12m from tip-283 proceed (~22:13 EDT), then re-read tip.
...
DATA = Path('/tmp/leblanc_plen_pars_iii_xl_densify')
PACKET_STEM = 'scripturae_plenitudine_pars_iii_xl_densify'
APPLY_COPY = BOOK / 'sources/_ocr_plenitudine/apply_scripturae_plenitudine_pars_iii_xl_densify.py'
...
SECS = ['284', '285', '286', '287', '288', '289', '290', '291']
ROMANS = {
    '284': 'XL', '285': 'XLI', '286': 'XLII', '287': 'XLIII',
    '288': 'XLIV', '289': 'XLV', '290': 'XLVI', '291': 'XLVII',
}

TIP_BEFORE = 283
LIVE_FLOOR = 4001
HOLD_START = datetime(2026, 9, 22, 22, 32, 41)
HOLD_MINUTES = 12

RANGE_SHORT = "Pars I I-XLVII + Pars II I-XXXV + Pars III I-XLI + Pars IV I-XLIV + De Scripturae plenitudine Pars I I-XXXVIII + Pars II I-XLIV + Pars III I-XLVII"
RANGE_TITLE = "Theological Theses (De Theologia I-XLIII; De Fide I-XXII; De Authoritate Scripturae Pars I I-XLVII; Pars II I-XXXV; Pars III I-XLI; Pars IV I-XLIV; De Scripturae plenitudine Pars I I-XXXVIII; Pars II I-XLIV; Pars III I-XLVII)"
EDITION = "Theses theologicae (London: Moses Pitt, 1675). ESTC R17887; Wing L802. IA bub_gb_eOkHAW4G0-wC. Densify: De Theologia I-XLIII + De Fide I-XXII + De Authoritate Scripturae Pars I I-XLVII + Pars II I-XXXV + Pars III I-XLI + Pars IV I-XLIV + De Scripturae plenitudine Pars I I-XXXVIII + Pars II I-XLIV + Pars III I-XLVII (not whole folio)."
BLURB = "Louis Le Blanc de Beaulieu - Sedan Theological Theses, newly rendered from the 1675 London Latin. Covers De Theologia I-XLIII, De Fide I-XXII, De Authoritate Scripturae through Pars IV XLIV, and De Scripturae plenitudine Pars I through XXXVIII, Pars II through XLIV, and Pars III through XLVII (sense of Scripture / pastors as interpreters / obscurity). Not the collected folio."
METHOD = "English follows the locked 1675 Pitt Latin of De Theologia I-XLIII, De Fide I-XXII, De Authoritate Scripturae Pars I I-XLVII, Pars II I-XXXV, Pars III I-XLI, Pars IV I-XLIV, and De Scripturae plenitudine Pars I I-XXXVIII + Pars II I-XLIV + Pars III I-XLVII, reconstructed from the Internet Archive PDF page images with pdftotext + tesseract (+ DjVu checks). The 1683 third edition was not used as copy-text. No modern English was copied. This slice densifies Plenitudine Pars III XL-XLVII (sense of Scripture; pastors; skilled vs infallible interpreter; tradition-lock retorsion). XLVIII+ remains."
...
LOCK_HEADER = (
    ...
    "PARS TERTIA — theses I-XLVII (sense of Scripture / pastors / obscurity / tradition lock).\n"
    "Same 1675 Pitt copy-text. Book pp. 54-82 / PDF 67-94 (Pars III XL-XLVII on PDF 92-94 / pp. 80-82). "
    "pdftotext + tess OCR (+ DjVu checks). Long-s and ligatures normalized. 1683 not copy-text. No modern English.\n"
    "Scope: Plenitudine Pars I through XXXVIII + Pars II through XLIV + Pars III through XLVII. Pars III XL+ remains.\n"
    "Note: Pars III I-XXXIX retained; XL-XLI sense/obscurity; XLII-XLV pastors/interpreters; XLVI-XLVII tradition-lock retorsion.\n\n"
)
...
def write_lock(latin: dict):
    ...
    for sec in [str(n) for n in range(245, 284)]:
        parts.append(by_prior[sec].rstrip() + chr(10))
    for sec in SECS:
...
def wait_hold():
    ...
    while True:
        ...
        if live_ok or timed_out:
            reason = f'live>{LIVE_FLOOR}' if live_ok else f'{HOLD_MINUTES}m since tip-283 hold start (live>4001)'
...
def build_packet_and_review():
    ...
    packet = make_audit_packet(
        ...
        raw_sources=[
            LOCK,
            pdf,
            Path('/tmp/leblanc_plen_pars_iii_xl_densify/pdf_92_95_layout.txt'),
            Path('/tmp/leblanc_plen_pars_iii_xl_densify/tess_92.txt'),
            Path('/tmp/leblanc_plen_pars_iii_xl_densify/tess_93.txt'),
            Path('/tmp/leblanc_plen_pars_iii_xl_densify/tess_94.txt'),
            Path('/tmp/leblanc_plen_pars_iii_xl_densify/latin.json'),
            BOOK / 'sources/_ocr_plenitudine/apply_scripturae_plenitudine_pars_iii_xxxii_densify.py',
        ],
    ...
    for sid in section_ids:
        ...
        if 284 <= n <= 291:
            notes = (
                f'Section {sid}: new densify De Scripturae plenitudine Pars III XL-XLVII; '
                'Pass A!=B; lock-grounded PDF 92-94 / book pp. 80-82.'
            )
        else:
            notes = (
                f'Section {sid}: prior verified densify retained; Pass A/B and lock identity '
                'rechecked in plenitudine Pars III XL packet scope covering all current sections.'
            )
        reviews.append({
            'section': sid,
            'verdict': 'pass',
    ...
    receipt = {
        ...
        'scope_review': {
            ...
            'uncertainties': [],
            'notes': (
                'Scope review: densify De Scripturae plenitudine Pars III XL-XLVII only '
                f'(sections {SECS[0]}-{SECS[-1]}). Meta discloses {RANGE_SHORT}. '
                'Honest partial; plenitudine Pars III through XLVII; XL+ remains. Prior tracts untouched. Not shipped.'
            ),
        },
        'reviews': reviews,
    }
...
def write_receipt(packet_path: Path, review_path: Path, live_tuple, packet: dict):
    ...
    receipt = {
        ...
        'locus': 'De Scripturae plenitudine Pars III theses XL-XLVII (sense of Scripture / pastors / obscurity / tradition lock)',
        'next_locus': 'De Scripturae plenitudine Pars III XLVIII+ (clarity vs sophistry close / final sufficiency argument)',
        'gates': {
...
def prepend_handoff(receipt: dict):
    ...
    block = (
        f"## {day} (Scribe — De Scripturae plenitudine Pars III XL–XLVII densify LOCAL)\n\n"
        f"- Before: **{receipt['before']}** (Plenitudine Pars III I–XXIII). After: **{receipt['after']}** "
        f"(contiguous Plenitudine Pars III XL–XLVII → §§{SECS[0]}–{SECS[-1]}).\n"
        ...
        "sophism; retorsion on Rome mixed rule; sufficient rule need not prove itself). XLVIII+ remains. De Theologia / De Fide / Authoritate / Plenitudine Pars I / Pars II / Pars III "
    ...
    repo_block = (
        f"## {day} ~ET (Scribe — Le Blanc Plenitudine Pars III XL–XLVII densify)\n\n"
        "CoS densify: De Scripturae plenitudine Pars III XXXII–XXXIX (word vs things / innate notes / integrity). "
        "Punch X: **NO**. No ship/commit/Logos/ai_promote.\n\n"
        "### Bound this job (not shipped)\n"
        f"- **Le Blanc** {slug_ref}: Plenitudine Pars III XL–XLVII (**"
        f"{receipt['before']}→{receipt['after']}** sections). Packet "
        f"{packet_ref}. Pass A≠B; tip-ready ok. Honest partial. Next: Pars III XLVIII+. "
        "Punch X: **NO**.\n\n---\n\n"
    )
