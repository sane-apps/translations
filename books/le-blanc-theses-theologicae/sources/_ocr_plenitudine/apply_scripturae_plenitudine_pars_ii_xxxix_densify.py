#!/usr/bin/env python3
"""De Scripturae plenitudine Pars II XXXIX-XLIV densify on Mini.

Lock + justifs (check_pass_ab each) first. Hold CLEARED at live 3822. Append eng/src after live >3821
OR 12m from tip-238 proceed (~20:49 EDT), then re-read tip.
...
DATA = Path('/tmp/leblanc_plen_pars_ii_xxxix_densify')
PACKET_STEM = 'scripturae_plenitudine_pars_ii_xxxix_densify'
APPLY_COPY = BOOK / 'sources/_ocr_plenitudine/apply_scripturae_plenitudine_pars_ii_xxxix_densify.py'
...
SECS = ['239', '240', '241', '242', '243', '244']
ROMANS = {
    '239': 'XXXIX', '240': 'XL', '241': 'XLI', '242': 'XLII',
    '243': 'XLIII', '244': 'XLIV',
}

TIP_BEFORE = 238
LIVE_FLOOR = 3821
HOLD_START = datetime(2026, 9, 22, 20, 49, 0)
HOLD_MINUTES = 12

RANGE_SHORT = 'Pars I I-XLVII + Pars II I-XXXV + Pars III I-XLI + Pars IV I-XLIV + De Scripturae plenitudine Pars I I-XXXVIII + Pars II I-XLIV'
RANGE_TITLE = 'Theological Theses (De Theologia I-XLIII; De Fide I-XXII; De Authoritate Scripturae Pars I I-XLVII; Pars II I-XXXV; Pars III I-XLI; Pars IV I-XLIV; De Scripturae plenitudine Pars I I-XXXVIII; Pars II I-XLIV)'
EDITION = 'Theses theologicae (London: Moses Pitt, 1675). ESTC R17887; Wing L802. IA bub_gb_eOkHAW4G0-wC. Densify: De Theologia I-XLIII + De Fide I-XXII + De Authoritate Scripturae Pars I I-XLVII + Pars II I-XXXV + Pars III I-XLI + Pars IV I-XLIV + De Scripturae plenitudine Pars I I-XXXVIII + Pars II I-XLIV (not whole folio).'
BLURB = 'Louis Le Blanc de Beaulieu - Sedan Theological Theses, newly rendered from the 1675 London Latin. Covers De Theologia I-XLIII, De Fide I-XXII, De Authoritate Scripturae through Pars IV XLIV, and De Scripturae plenitudine Pars I through XXXVIII plus Pars II through XLIV (closes Pars II; spurious-writings / judge / consensus). Not the collected folio.'
METHOD = 'English follows the locked 1675 Pitt Latin of De Theologia I-XLIII, De Fide I-XXII, De Authoritate Scripturae Pars I I-XLVII, Pars II I-XXXV, Pars III I-XLI, Pars IV I-XLIV, and De Scripturae plenitudine Pars I I-XXXVIII + Pars II I-XLIV, reconstructed from the Internet Archive PDF page images with pdftotext + tesseract (+ DjVu checks). The 1683 third edition was not used as copy-text. No modern English was copied. This slice closes Plenitudine Pars II through XLIV (spurious writings XXXIX; Pope/Council judge XL-XLIII; perpetual consensus XLIV). Pars III remains.'

LOCK_HEADER = 'Locked Latin: Louis Le Blanc, Theses theologicae (London: Moses Pitt, 1675).\nTract: De Scripturae Plenitudine et Sufficientia adversus necessitatem verbi cujusdam non scripti.\nPARS PRIMA — theses I-XXXVIII retained.\nPARS SECUNDA — theses I-XLIV (closes with perpetual-consensus test XLIV).\nSame 1675 Pitt copy-text. Book pp. 54-71 / PDF 67-83 (Pars II XXXIX-XLIV on PDF 81-83 / pp. 69-71). pdftotext + tess OCR (+ DjVu checks). Long-s and ligatures normalized. 1683 not copy-text. No modern English.\nScope: Plenitudine Pars I through XXXVIII + Pars II through XLIV (Pars II closed). Pars III remains.\nNote: I-XXXVIII retained; XXXIX spurious writings; XL-XLI Pope/Council; XLII circle; XLIII hand-chain; XLIV consensus.\n\n'
...
def write_lock(latin: dict):
    ...
    for sec in [str(n) for n in range(201, 239)]:
...
def wait_hold():
    ...
    while True:
        ...
        if live_ok or timed_out:
            reason = f'live>{LIVE_FLOOR}' if live_ok else f'{HOLD_MINUTES}m since tip-238 hold start'
...
def build_packet_and_review():
    ...
    receipt = {
        ...
        'scope_review': {
            ...
            'uncertainties': [],
            'notes': (
                'Scope review: densify De Scripturae plenitudine Pars II XXXIX-XLIV only '
                f'(sections {SECS[0]}-{SECS[-1]}). Meta discloses {RANGE_SHORT}. '
                'Honest partial; plenitudine Pars II closed through XLIV; Pars III remains. Prior tracts untouched. Not shipped.'
            ),
        },
        'reviews': reviews,
    }
...
def write_receipt(packet_path: Path, review_path: Path, live_tuple, packet: dict):
    ...
    receipt = {
        ...
        'locus': 'De Scripturae plenitudine Pars II theses XXXIX-XLIV (spurious writings / living judge / consensus; closes Pars II)',
        'next_locus': 'De Scripturae plenitudine Pars III (Roman arguments against Scripture sufficiency)',
        'gates': {
...
def prepend_handoff(receipt: dict):
    ...
    parts = [
        "## " + day + " (Scribe — De Scripturae plenitudine Pars II XXXIX–XLIV densify LOCAL)\n\n",
        "- Before: **" + str(receipt["before"]) + "** (Plenitudine Pars II I–XXXVIII). After: **"
        + str(receipt["after"]) + "** ",
        "(contiguous Plenitudine Pars II XXXIX–XLIV → §§" + SECS[0] + "–" + SECS[-1] + ").\n",
        "- Packet " + packet_ref + " (" + packet_files + "). ",
        "Reviewer: scribe-leblanc, " + day + ". Verdict pass grounded in ",
        lock_ref + " (PDF 81–83 / book pp. 69–71).\n",
        "- Meta range bumped to **" + RANGE_SHORT + "** (title, edition, blurb, text_history.method).\n",
                        "- Honest **partial**: Plenitudine Pars II closed through XLIV (spurious/doubted apostolic "
        "writings; Pope vs Council living judge; no title-deed; circular infallible judge; hand-to-hand "
        "chain / Augustine interminable; perpetual consensus fails Rome). Pars III remains. De Theologia / "
        "De Fide / Authoritate / Plenitudine Pars I / Pars II I–XXXVIII closed as before. Not folio. Not shipped.\n",
        "- Pass A ≠ B for §§" + SECS[0] + "–" + SECS[-1] + ". Rogavi pro te; duo vel tres; "
        "Interminabilis; sub altero tantum symbolo. OCR restorations noted in translator_notes.\n",
    ...
    repo_block = (
        "## " + day + " ~ET (Scribe — Le Blanc Plenitudine Pars II XXXIX–XLIV densify)\n\n"
        "CoS densify: De Scripturae plenitudine Pars II XXXIX–XLIV (closes Pars II). "
        "Punch X: **NO**. No ship/commit/Logos/ai_promote.\n\n"
        "### Bound this job (not shipped)\n"
        "- **Le Blanc** " + slug_ref + ": Plenitudine Pars II XXXIX–XLIV (**"
        + str(receipt["before"]) + "→" + str(receipt["after"]) + "** sections). Packet "
        + packet_ref + ". Pass A≠B; tip-ready ok. Honest partial. Next: Pars III. "
        "Punch X: **NO**.\n\n---\n\n"
    )
