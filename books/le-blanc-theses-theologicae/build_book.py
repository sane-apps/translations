"""Build Le Blanc Theological Theses Logos Personal Book DOCX."""
...
OUT_DOCX = BOOK_DIR / "le-blanc-theses-theologicae.docx"
RECEIPT = BOOK_DIR / "build_receipt.json"

ENGLISH_FILE = "theses_theologia_english.json"
SOURCE_FILE = "theses_theologia_source.json"
META_FILE = "theses_theologia_meta.json"
...
def main() -> None:
    ...
    doc = setup_document(
        ...
        keywords="Le Blanc, Theological Theses, Sedan, Reformed",
    )
    linker = BibleLinker()
