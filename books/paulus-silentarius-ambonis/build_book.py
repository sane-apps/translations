"""Build Paulus Silentarius Description of the Pulpit Logos Personal Book DOCX."""
...
def main() -> None:
    ...
    doc = setup_document(
        ...
        keywords="Paulus Silentarius, Hagia Sophia, pulpit, ekphrasis, 563 AD",
    )
    ...
    add_heading_with_headword(doc, bookmarks, "Description of the Pulpit", 1, "ambon-work")
