"""Build Gregory Thaumaturgus Ecclesiastes metaphrase Logos Personal Book DOCX."""
...
OUT_DOCX = BOOK_DIR / "gregory-thaumaturgus-ecclesiastes-metaphrase.docx"
RECEIPT = BOOK_DIR / "build_receipt.json"

ENGLISH_FILE = "eccl_metaphrase_english.json"
SOURCE_FILE = "eccl_metaphrase_source.json"
META_FILE = "eccl_metaphrase_meta.json"

FRONT_MATTER = [
    "New English rendering for private study, prepared with AI assistance from locked Greek. No modern copyrighted translation has been copied. Prior English (ANF 4 Crombie, PD) consulted only as sense/style check.",
    "Scope: Metaphrasis in Ecclesiasten. Tip covers Cap. I opening from locked MGR Greek through Solomon as king in Jerusalem carefully considering all things; remainder remains.",
    "Editorial note: Greek copy-text is the MGR concordance extract (TLG 2063.006). Vossius 1684 Latin column DjVu OCR is retained as a check witness only.",
...
def main() -> None:
    doc = setup_document(
        title="Gregory Thaumaturgus: Metaphrasis in Ecclesiasten (New English)",
        author="Gregory Thaumaturgus",
        subject="New English rendering for private Logos study",
        keywords="Gregory Thaumaturgus, Ecclesiastes, Metaphrasis",
    )
    linker = BibleLinker()
    doc.add_paragraph("Gregory Thaumaturgus: Metaphrasis in Ecclesiasten", style="Title")
    ...
    add_heading_with_headword(doc, bookmarks, "Metaphrasis in Ecclesiasten", 1, "eccl-metaphrase-work")
    ...
    if tn_records:
        ...
        doc.add_paragraph(
            ...
            "wording choices, and rough passages — not Gregory's text."
        )
