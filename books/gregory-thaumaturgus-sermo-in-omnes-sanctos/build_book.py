"""Build Gregory Thaumaturgus Sermo in omnes sanctos Logos Personal Book DOCX."""
...
OUT_DOCX = BOOK_DIR / "gregory-thaumaturgus-sermo-in-omnes-sanctos.docx"
RECEIPT = BOOK_DIR / "build_receipt.json"

ENGLISH_FILE = "omnes_sanctos_english.json"
SOURCE_FILE = "omnes_sanctos_source.json"
META_FILE = "omnes_sanctos_meta.json"

FRONT_MATTER = [
    "New English rendering for private study, prepared with AI assistance from locked Greek. No modern copyrighted translation has been copied. Prior English (ANF 6 Salmond, PD) consulted only as sense/style check.",
    "Scope: Sermo in omnes sanctos. Tip covers opening through Christ despoiling Hades / sting of death from locked MGR Greek; remainder remains.",
    "Editorial note: attribution to Gregory Thaumaturgus is disputed in modern scholarship and is disclosed. Greek copy-text is the MGR extract (TLG 2063.010).",
...
def main() -> None:
    doc = setup_document(
        title="Gregory Thaumaturgus: On All the Saints (New English)",
        author="Gregory Thaumaturgus",
        subject="New English rendering for private Logos study",
        keywords="Gregory Thaumaturgus, All Saints, martyrs",
    )
    linker = BibleLinker()
    doc.add_paragraph("Gregory Thaumaturgus: On All the Saints", style="Title")
    ...
    add_heading_with_headword(doc, bookmarks, "On All the Saints", 1, "omnes-sanctos-work")
