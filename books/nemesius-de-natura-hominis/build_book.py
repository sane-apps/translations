...
OUT_DOCX = BOOK_DIR / "nemesius-de-natura-hominis.docx"
RECEIPT = BOOK_DIR / "build_receipt.json"

# Source JSON filename in translations/
ENGLISH_FILE = "nature_hominis_english.json"
...
_STOP = {
    ...
    "with", "would", "neme", "sius", "greek", "latin", "lxx", "also", "than", "then", "that",
...
def main() -> None:
    ...
    first_english = True
    first_english_note = "No previous English translation (Wither 1636 exists; this is new)."
    if meta_path.exists():
    ...
    if tn_records:
        ...
        doc.add_paragraph(
            ...
            "wording choices, and rough passages — not Nemesius's text."
        )
