"""Build Cyril of Alexandria, On Adoration Book 1, Logos Personal Book DOCX."""
...
OUT_DOCX = BOOK_DIR / "cyril-alexandria-adoration-1.docx"
RECEIPT = BOOK_DIR / "build_receipt.json"

WORKS = [
    (
        "adoration1_english.json",
        "On Adoration and Worship in Spirit and Truth, Book 1",
        "ador1",
        "De adoratione et cultu in spiritu et veritate, Book 1. Migne PG 68.134–211.",
    ),
]
