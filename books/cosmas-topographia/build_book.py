"""Stub builder for Cosmas Indicopleustes: Topographia Christiana. Replace with book-specific assembly; use pipeline helpers."""
...
def main():
    doc = setup_document(
        title="Cosmas Indicopleustes: Topographia Christiana",
    ...
    out = ROOT / "cosmas-topographia English.docx"
    doc.save(out)
    receipt = {
        "section_count": 1,
