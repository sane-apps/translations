"""Build Strimesius Candid Examination of the Gospel Controversies Logos Personal Book DOCX."""
...
def main() -> None:
    ...
    doc = setup_document(
        ...
        keywords="Strimesius, gospel controversies, Lord's Supper, Augsburg Confession",
    )
    ...
    add_heading_with_headword(doc, bookmarks, "Candid Examination of the Gospel Controversies", 1, "theologia-work")
