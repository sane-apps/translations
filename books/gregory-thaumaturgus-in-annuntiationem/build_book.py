"""Build Gregory Thaumaturgus In annuntiationem Logos Personal Book DOCX."""
...
OUT_DOCX = BOOK_DIR / "gregory-thaumaturgus-in-annuntiationem.docx"
RECEIPT = BOOK_DIR / "build_receipt.json"

ENGLISH_FILE = "annunciation_english.json"
SOURCE_FILE = "annunciation_source.json"
META_FILE = "annunciation_meta.json"
...
FRONT_MATTER = [
    ...
    "Scope: In annuntiationem sanctissimae Dei genitricis Virginis Mariae, Sermo I. Tip covers opening through Gabriel reply from locked Vossius 1684 Latin; Sermones II-III and the rest of Sermo I remain.",
    "Editorial note: Vossius scholia (including later immaculate-conception polemic) are not the work and were stripped from the lock. Greek column OCR is damaged and is not copy-text.",
...
def main() -> None:
    doc = setup_document(
        title="Gregory Thaumaturgus: On the Annunciation (New English)",
        author="Gregory Thaumaturgus",
        subject="New English rendering for private Logos study",
        keywords="Gregory Thaumaturgus, Annunciation, Mary",
    )
    linker = BibleLinker()
    doc.add_paragraph("Gregory Thaumaturgus: On the Annunciation", style="Title")
    ...
    add_heading_with_headword(doc, bookmarks, "On the Annunciation", 1, "annuntiationem-work")
