"""Build Gregory Thaumaturgus De fide XII Logos Personal Book DOCX."""
...
OUT_DOCX = BOOK_DIR / "gregory-thaumaturgus-de-fide-xii.docx"
RECEIPT = BOOK_DIR / "build_receipt.json"

ENGLISH_FILE = "fide_xii_english.json"
SOURCE_FILE = "fide_xii_source.json"
META_FILE = "fide_xii_meta.json"

FRONT_MATTER = [
    "New English rendering for private study, prepared with AI assistance from locked Greek. No modern copyrighted translation has been copied. Prior English (ANF 6 Crombie, PD) consulted only as sense/style check.",
    "Scope: Twelve Chapters on the Faith (Duodecim Capita). Tip covers Capita I-II from locked Vossius 1684 Latin.",
...
def main() -> None:
    doc = setup_document(
        title="Gregory Thaumaturgus: Twelve Chapters on the Faith (New English)",
        author="Gregory Thaumaturgus",
        subject="New English rendering for private Logos study",
        keywords="Gregory Thaumaturgus, De fide, incarnation",
    )
    doc.add_paragraph("Gregory Thaumaturgus: Twelve Chapters on the Faith", style="Title")
    ...
    add_heading_with_headword(doc, bookmarks, "Twelve Chapters on the Faith", 1, "fide-xii-work")
