"""Build Gregory Thaumaturgus Twelve Chapters on the Faith Logos Personal Book DOCX."""
...
def main() -> None:
    ...
    doc = setup_document(
        ...
        keywords="Gregory Thaumaturgus, Twelve Chapters on the Faith, incarnation",
    )
