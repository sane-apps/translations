#!/usr/bin/env python3
"""Write morte_241..245 justifications; check_pass_ab after each."""
...
def main() -> None:
    ...
    for sec in SECTIONS:
        ...
        jx = {
            ...
            "bible_refs": [],
            "notes": (
                f"Densify De praedestinatione Cap. II Arg. 3 section {n}. "
            ...
            "choices": [
                {
                    ...
                    "choice": (
                        ...
                        "with sense normalize; lock: sources/_davenant_praedestinatione_cap2_arg3_latin_lock.txt."
                    ),
                },
                {
                    "issue": "Scope",
                    "choice": (
                        "Cap. II Arg. 3 (1 Cor. 2:9 / those who love him) and Sol. "
                        "(after Cap. II Arg. 2 Sol.; before Cap. II Arg. 4 / 2 Tim. 2:21)."
                    ),
                },
            ],
        }
