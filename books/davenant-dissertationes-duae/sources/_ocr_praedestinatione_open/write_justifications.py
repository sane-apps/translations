#!/usr/bin/env python3
"""Write morte_193..200 justifications; check_pass_ab after each."""
...
def main() -> None:
    ...
    for sec in SECTIONS:
        ...
        jx = {
            ...
            "bible_refs": [],
            "notes": (
                f"Densify De praedestinatione Prefatio/Cap.1 Prolegomena section {n}. "
            ...
            "choices": [
                {
                    ...
                    "choice": (
                        ...
                        "with sense normalize; lock: sources/_davenant_praedestinatione_open_latin_lock.txt."
                    ),
                },
                {
                    "issue": "Scope",
                    "choice": (
                        "De praedestinatione et reprobatione title + Prefatio + Cap. 1 Prolegomena I–III "
                        "(before Electio/Praedestinatio/Reprobatio vocabulary)."
                    ),
                },
            ],
        }
