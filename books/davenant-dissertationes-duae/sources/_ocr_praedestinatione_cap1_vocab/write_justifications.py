#!/usr/bin/env python3
"""Write morte_201..207 justifications; check_pass_ab after each."""
...
def main() -> None:
    ...
    for sec in SECTIONS:
        ...
        jx = {
            ...
            "bible_refs": [],
            "notes": (
                f"Densify De praedestinatione Cap.1 vocabulary section {n}. "
            ...
            "choices": [
                {
                    ...
                    "choice": (
                        ...
                        "with sense normalize; lock: sources/_davenant_praedestinatione_cap1_vocab_latin_lock.txt."
                    ),
                },
                {
                    "issue": "Scope",
                    "choice": (
                        "Cap. 1 vocabulary Electio / Praedestinatio / Reprobatio "
                        "(after Prolegomena I–III; before Cap. 1 subject-condition Prolegomena III)."
                    ),
                },
            ],
        }
