#!/usr/bin/env python3
"""Write morte_246..250 justifications; check_pass_ab after each."""
...
def main() -> None:
    ...
    for sec in SECTIONS:
        ...
        jx = {
            ...
            "bible_refs": [],
            "notes": (
                f"Densify De praedestinatione Cap. II Arg. 4 section {n}. "
            ...
            "choices": [
                {
                    ...
                    "choice": (
                        ...
                        "with sense normalize; lock: sources/_davenant_praedestinatione_cap2_arg4_latin_lock.txt."
                    ),
                },
                {
                    "issue": "Scope",
                    "choice": (
                        "Cap. II Arg. 4 (2 Tim. 2:21 vessels unto honour) and Sol. "
                        "(after Cap. II Arg. 3 Sol.; before Cap. II Arg. 5 / 1 Tim. 2:4)."
                    ),
                },
            ],
        }
