#!/usr/bin/env python3
"""Write morte_283..287 justifications; check_pass_ab after each."""
...
def main() -> None:
    ...
    for sec in SECTIONS:
        ...
        jx = {
            ...
            "bible_refs": [],
            "notes": (
                f"Densify De praedestinatione Cap. III Rat. 3 section {n}. "
            ...
            "choices": [
                {
                    ...
                    "choice": (
                        ...
                        "with sense normalize; lock: sources/_davenant_praedestinatione_cap3_rat3_latin_lock.txt."
                    ),
                },
                {
                    "issue": "Scope",
                    "choice": (
                        "Cap. III adversariorum rationes Rat. 2 (king/prize / victory foresight analogy) and Resp. "
