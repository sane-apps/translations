#!/usr/bin/env python3
"""Write morte_264..270 justifications; check_pass_ab after each."""
...
def main() -> None:
    ...
    for sec in SECTIONS:
        ...
        jx = {
            ...
            "bible_refs": [],
            "notes": (
                f"Densify De praedestinatione Cap. II Arg. 7 section {n}. "
            ...
            "choices": [
                {
                    ...
                    "choice": (
                        ...
                        "with sense normalize; lock: sources/_davenant_praedestinatione_cap2_arg7_latin_lock.txt."
                    ),
                },
                {
                    "issue": "Scope",
                    "choice": (
                        "Cap. II Arg. 7 (Apoc. 3:11 hold fast / crown) and Sol. "
                        "(after Cap. II Arg. 6 Sol.; before Cap. III adversariorum rationes)."
                    ),
                },
            ],
        }
