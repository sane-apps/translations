#!/usr/bin/env python3
"""Write morte_222..228 justifications; check_pass_ab after each."""
...
def main() -> None:
    ...
    for sec in SECTIONS:
        ...
        jx = {
            ...
            "bible_refs": [],
            "notes": (
                f"Densify De praedestinatione Cap. II Variae illorum sententiae section {n}. "
            ...
            "choices": [
                {
                    ...
                    "choice": (
                        ...
                        "with sense normalize; lock: sources/_davenant_praedestinatione_cap2_variae_latin_lock.txt."
                    ),
                },
                {
                    "issue": "Scope",
                    "choice": (
                        "Cap. II Variae illorum sententiae (election from foresight merits / Pelagian opening) "
                        "(after Cap. 1 Prolegomena IV close; before Cap. II Scholastics)."
                    ),
                },
            ],
        }
