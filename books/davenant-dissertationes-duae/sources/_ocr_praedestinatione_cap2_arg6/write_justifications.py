#!/usr/bin/env python3
"""Write morte_257..263 justifications; check_pass_ab after each."""
...
def main() -> None:
    ...
    for sec in SECTIONS:
        ...
        jx = {
            ...
            "bible_refs": [],
            "notes": (
                f"Densify De praedestinatione Cap. II Arg. 6 section {n}. "
            ...
            "choices": [
                {
                    ...
                    "choice": (
                        ...
                        "with sense normalize; lock: sources/_davenant_praedestinatione_cap2_arg6_latin_lock.txt."
                    ),
                },
                {
                    "issue": "Scope",
                    "choice": (
                        "Cap. II Arg. 6 (James 2:5 poor elect / rich in faith) and Sol. "
                        "(after Cap. II Arg. 5 Sol.; before Cap. II Arg. 7 / Apoc. 3:11)."
                    ),
                },
            ],
        }
