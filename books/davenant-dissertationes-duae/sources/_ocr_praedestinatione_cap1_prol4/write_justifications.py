#!/usr/bin/env python3
"""Write morte_215..221 justifications; check_pass_ab after each."""
...
def main() -> None:
    ...
    for sec in SECTIONS:
        ...
        jx = {
            ...
            "bible_refs": [],
            "notes": (
                f"Densify De praedestinatione Cap.1 Prolegomena IV distinguishing conditions section {n}. "
            ...
            "choices": [
                {
                    ...
                    "choice": (
                        ...
                        "with sense normalize; lock: sources/_davenant_praedestinatione_cap1_prol4_latin_lock.txt."
                    ),
                },
                {
                    "issue": "Scope",
                    "choice": (
                        "Cap. 1 Prolegomena IV distinguishing conditions (works / faith foresight) "
                        "(after Cap. 1 subject-condition Prolegomena III; before Cap. II theses on election)."
                    ),
                },
            ],
        }
