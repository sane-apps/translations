#!/usr/bin/env python3
"""Write morte_236..240 justifications; check_pass_ab after each."""
...
def main() -> None:
    ...
    for sec in SECTIONS:
        ...
        jx = {
            ...
            "bible_refs": [],
            "notes": (
                f"Densify De praedestinatione Cap. II Arg. 2 section {n}. "
            ...
            "choices": [
                {
                    ...
                    "choice": (
                        ...
                        "with sense normalize; lock: sources/_davenant_praedestinatione_cap2_arg2_latin_lock.txt."
                    ),
                },
                {
                    "issue": "Scope",
                    "choice": (
                        "Cap. II Arg. 2 (praescientia loci Rom. 8 / 11 / 1 Pet. 1) and Sol. "
                        "(after Cap. II Vasquez Arg. 1 Sol.; before Cap. II Arg. 3 / 1 Cor. 2:9)."
                    ),
                },
            ],
        }
