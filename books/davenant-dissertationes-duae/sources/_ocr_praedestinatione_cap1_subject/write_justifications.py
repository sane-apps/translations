#!/usr/bin/env python3
"""Write morte_208..214 justifications; check_pass_ab after each."""
...
def main() -> None:
    ...
    for sec in SECTIONS:
        ...
        jx = {
            ...
            "bible_refs": [],
            "notes": (
                f"Densify De praedestinatione Cap.1 subject conditions section {n}. "
            ...
            "choices": [
                {
                    ...
                    "choice": (
                        ...
                        "with sense normalize; lock: sources/_davenant_praedestinatione_cap1_subject_latin_lock.txt."
                    ),
                },
                {
                    "issue": "Scope",
                    "choice": (
                        "Cap. 1 subject conditions (rationality / sin presupposed) "
                        "(after Cap. 1 vocabulary; before Cap. 1 distinguishing conditions / Prolegomena IV)."
                    ),
                },
            ],
        }
