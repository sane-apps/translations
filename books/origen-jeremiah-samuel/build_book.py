"""Build Origen Homilies on Jeremiah + 1 Samuel 28 Logos Personal Book DOCX."""
...
OUT_DOCX = BOOK_DIR / "origen-jeremiah-samuel.docx"
RECEIPT = BOOK_DIR / "build_receipt.json"

WORKS = [
    (
        "jeremiah_english.json",
        "Homilies on Jeremiah",
        "jer",
        "Homilies on Jeremiah. Klostermann, Origenes Werke III (GCS 6, 1901). Homilies 1–2 in this file; 3–20 still to come.",
    ),
    (
        "samuel_english.json",
