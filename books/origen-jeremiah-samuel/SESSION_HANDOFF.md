...
- 2026-09-11 (witness disclosure): Site “About this text” names GCS 1901 as copy-text, Archive page image/DjVu and First1KGreek TEI as checks of the same print, and TEI-vs-page-image joins. Later JSON drafts stay off the public reader unless `publish_homilies` lists them. Do not claim PG 13 or Jerome until those are locked and shipped. No silent merge.
...
- Homilies 3–4 receipts now have `pass_a_gloss` ≠ Pass B (2026-09-11 evening). CF 6–7, 9–10 remain `machine_draft` (no source_text/choices); not published.
