...
**1 Samuel 28 OET Pass B shipped** (Air tip; claim `origen-samuel28-oet`). Chronological OET forward in this volume: **Homily 8 polished**; Lam §§1–10 tipped; Lam §§1–20 tipped; Lam §§1–30 tipped; continue **Lamentations** §§31+ (`lamentations_source.json`). Homilies 1–7, 9–20 already Pass B on site. Do not present the English set as Logos-complete. **Logos Personal Book compile stays on the owner’s MacBook Air only** — contributors and overnight agents never run `build_book.py` / Logos Build. Never Cyril Matthew; CPG 5219/5220 closed. OET = no previous English translation.
