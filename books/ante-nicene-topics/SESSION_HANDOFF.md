## Air mine 2026-09-12 — arnobius_nations_2_30
- Claim `arnobius-nations-2-30-mine` → **reward-and-judgment**.
- Adv. Nat. 2.30: poenae inferorum; animae incorruptibiles; philosophiae causa.
...
## Air mine 2026-09-12 — tertullian_de_anima_20
- Claim `tertullian-de-anima-20-mine` → **free-will**.
- sortes / fatum / arbitrii libertas / Adam matrix.
- Pass A ≠ B; jer-h20b intact; Melito skipped; no CSS.
...
## Air mine 2026-09-12 — tertullian_paenitentia_8
- Claim `tertullian-paenitentia-8-mine` → **faith-and-obedience**.
- ecclesiis / paenitentiam / confessio / dissimulatio.
- Pass A ≠ B; jer-h20b intact; Melito skipped; no CSS.
...
## Air mine 2026-09-12 — Lactantius Inst. 7.6
- Claim `lactantius-inst-7-6-mine` closed; excerpt `lactantius_inst_7_6` → **true-worship**.
- adgnoscamus / colamus / immortalitatem / aeternum deo regnum; Book 7 eschatology lane.
- Pass A ≠ Pass B; jer-h20b intact; Melito skipped; no CSS.
...
## Air mine 2026-09-12 — Lactantius Inst. 7.1
- Claim `lactantius-inst-7-1-mine` closed; excerpt `lactantius_inst_7_1` → **reward-and-judgment**.
- praemium beatitudinis / caelesti mercede / iudicio dei; Book 7 eschatology lane.
- Pass A ≠ Pass B; jer-h20b intact; Melito skipped; no CSS.

# Air Cursor handoff — Ante-Nicene Dogmatics (2026-09-10)

## Version
- **Book:** `0.8.4`
- **Title:** Ante-Nicene Dogmatics · **Subtitle:** The Fathers on the Full Counsel of God
- **MVP:** **48/48** `source_verified` (Melito + Victorinus unlocked)
- **Professional GTG: Yes**
- **Sellable GTG: No**
- Rebuild DOCX done for 0.8.4 wording; Logos rebuild if shipping

## Caveats closed (0.8.3–0.8.4)
| Item | Result |
|------|--------|
| Irenaeus Harvey print ×4 | pass |
| Melito Greek οὐσίαι | locked + promoted |
| Victorinus PL/Walker | continuous print locked + promoted |
| Same-locus Melito in christology seeds | English synced (still seed_edition) |

## Evidence
- `outputs/reviews/second_model_golden_set_audit_2026-09-10_v081.md`
