"""Build Gregory Thaumaturgus Ad Tatianum de anima Logos Personal Book DOCX."""
...
OUT_DOCX = BOOK_DIR / "gregory-thaumaturgus-ad-tatianum-de-anima.docx"
RECEIPT = BOOK_DIR / "build_receipt.json"

ENGLISH_FILE = "anima_tatianum_english.json"
SOURCE_FILE = "anima_tatianum_source.json"
META_FILE = "anima_tatianum_meta.json"
...
FRONT_MATTER = [
    ...
    "Scope: Disputatio de Anima ad Tatianum. Tip densify preface + inquiry program from locked Vossius 1684 Latin.",
    "Editorial note: the commission itself forbids Scripture testimonies in this disputation, so the tip English has no inline Bible quotes from Gregory.",
...
def main() -> None:
    doc = setup_document(
        title="Gregory Thaumaturgus: On the Soul, to Tatian (New English)",
        author="Gregory Thaumaturgus",
        subject="New English rendering for private Logos study",
        keywords="Gregory Thaumaturgus, De anima, soul",
    )
    linker = BibleLinker()
    doc.add_paragraph("Gregory Thaumaturgus: On the Soul, to Tatian", style="Title")
    ...
    add_heading_with_headword(doc, bookmarks, "On the Soul, to Tatian", 1, "anima-tatianum-work")
