# Epiphanius: Panarion — production ledger

Canonical path: `~/SaneApps/clients/translations/books/epiphanius-panarion/`

## Charter

- Title: Epiphanius: Panarion
...
- **tip-ready:** PASS for Haer. I Cap. V: no heresy yet; Adam prophet of Father, Son, Spirit.
- **Source locked:** PG 41 OCR; scaffold discarded.
- **Pass A≠B:** OK.
- **DOCX:** `epiphanius-panarion.docx` verify OK.
- **Claim:** remains **prepped**.


## Densify tip live (2026-09-15 ~3:18 PM ET)
- Live: https://fathers.saneapps.com/works/epiphanius-panarion/
- Deploy: https://2b59e8db.fathers-site.pages.dev (live_works=48)
- Tip real-locked from PG OCR; scaffold English discarded; Pass A!=B; LOGOS_MARKUP DOCX; fathers wired; claims stay prepped.
