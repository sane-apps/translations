"""Build Epiphanius The Panarion Logos Personal Book DOCX."""
...
def main() -> None:
    ...
    doc = setup_document(
        ...
        keywords="Epiphanius, The Panarion, heresies",
    )
    ...
    add_heading_with_headword(doc, bookmarks, "The Panarion", 1, "panarion-work")
