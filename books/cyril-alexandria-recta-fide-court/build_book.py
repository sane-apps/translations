...
OUT_DOCX = BOOK_DIR / "cyril-alexandria-recta-fide-court.docx"
RECEIPT = BOOK_DIR / "build_receipt.json"

WORKS = [
    (
        "ad_arcadiam_marinamque_english.json",
        "To Arcadia and Marina",
        "arc",
        "CPG 5219, De recta fide ad Arcadiam Marinamque. Greek: Pusey 1877, pp. 155–264.",
    ),
    (
        "ad_pulcheriam_eudociamque_english.json",
        "To Pulcheria and Eudocia",
        "pul",
        "CPG 5220, De recta fide ad Pulcheriam et Eudociam. Greek: Pusey 1877, pp. 265–333.",
    ),
]

FRONT_MATTER = [
    "New English rendering for private study, prepared with AI assistance from the Greek text (Pusey 1877 edition of Cyril; Migne PG 76 reprint lineage). No modern copyrighted translation has been copied. A modern version may have been consulted only as a sense or style check.",
    "Scope: CPG 5219 (To Arcadia and Marina) and CPG 5220 (To Pulcheria and Eudocia) only. De recta fide ad Theodosium is NOT in this volume — a modern English of that treatise already exists (King FC 129). This is not Cyril of Jerusalem, and not the complete Cyril corpus.",
...
def main() -> None:
    doc = setup_document(
        ...
        keywords="Cyril of Alexandria, De recta fide, post-Nicene",
    )
    doc.add_paragraph(
